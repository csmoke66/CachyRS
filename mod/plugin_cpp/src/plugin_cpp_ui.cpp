...
namespace crs
{
    ...
    ApiContainer::ApiContainer() : ApiComponent({nullptr}, (uint64_t)-1)
    {
    }
    ...
    std::shared_ptr<ApiDropDown> ApiContainer::add_dropdown(std::initializer_list<std::string> options)
    {
    ...
    ApiCheckBox::ApiCheckBox() : ApiComponent({nullptr}, (uint64_t)-1)
    {
    }
