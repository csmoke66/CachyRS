...
static_assert(off(Globals, menu_action_handler_widget1) == 0xf4320, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_widget2) == 0xf4470, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_widget3) == 0x127100, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_walk) == 0x169e00, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc7) == 0x16a5f0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc6) == 0x16a610, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc5) == 0x16a630, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc4) == 0x16a650, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc3) == 0x16a670, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc2) == 0x16a690, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_npc1) == 0x16a6b0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj7) == 0x16aa50, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj6) == 0x16aa70, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj5) == 0x16aa90, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj4) == 0x16aab0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj3) == 0x16aad0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj2) == 0x16aaf0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj1) == 0x16ab10, INVALID_OFFSET);
