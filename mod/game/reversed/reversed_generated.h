...
static_assert(off(Globals, menu_action_handler_obj7) == 0x162af0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj6) == 0x162b20, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj5) == 0x162b40, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj4) == 0x162b60, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj3) == 0x162b80, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj2) == 0x162ba0, INVALID_OFFSET);
static_assert(off(Globals, menu_action_handler_obj1) == 0x162bc0, INVALID_OFFSET);
